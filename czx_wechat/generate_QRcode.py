...
appID = 'wx80b1ffefb199c134'
appsecret = 'f6fda6e301c8d84cf1dc21e1b9a1c77c'
...
获取access_token分析
1. access_token多给个地方都要使用，所以需要使用变量记录
...
class AccessToken(object):
    ...
    def get_access_token(cls):
        ...
        # 判断access_token是否有值，或者过期。如果为空或者过期需要指定URL获取access_token
